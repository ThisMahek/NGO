                            ...
                            <form action="<?=base_url()?>User/save_origination" method="post">
                                ...
                                <input type="hidden"  value="<?=$organisation->id?>" name="id" required>
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="pan_id" value="<?=$organisation->it_pan?>" oninput="validatePan('pan_id','pan_error','btn')" name="it_pan" required>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="" value="<?=$organisation->organisation_name?>" name="organisation_name" required>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label for="exampleInputEmail1" class="form-label">Organisation Email Id.<span class="text-danger">*</span></label>
                                        <input type="email" class="form-control" id="" value="<?=$this->session->userdata('email')?>" name="" disabled required>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label for="exampleInputEmail1" class="form-label">Organisation Website (URL)<span class="text-danger">*</span></label>
                                        <input type="url" class="form-control" id="" value="<?=$organisation->website_url?>" name="website_url" required>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label for="exampleInputEmail1" class="form-label">Name of Person Filling the Form<span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" id="" value="<?=$organisation->person_name?>" name="person_name"  onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode==32)" required>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="" value="<?=$organisation->contact_person?>" name="contact_person" onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode==32)" required>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label for="exampleInputEmail1" class="form-label">Designation of Contact Person<span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" id="" value="<?=$organisation->cp_designation?>" name="cp_designation" onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode==32)" required>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="email" class="form-control" id="email_id" value="<?=$organisation->cp_email_id?>" name="cp_email_id" oninput="validate_email('email_id','email_error','btn')" required>
