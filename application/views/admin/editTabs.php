                            ...
                            <form action="#" method="POST">
                                <div class="row justify-content-center"> 
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" class="form-control" id="" name="" value="1" required>
                                    </div> 
                                    <div class="col-md-6">
                                        <label for="exampleInputEmail1" class="form-label">Tab Name*</label>
                                        <input type="text" class="form-control" id="" name="" value="About Us" required>
                                    </div> 
                                    <div class="col-md-6 mt-3">
                                        <label for="exampleInputEmail1" class="form-label">Url*</label>
                                        <input type="text" class="form-control" id="" name="" value="about_us.php" required>
                                    </div> 
                                    <div class="col-md-6 mt-3">
